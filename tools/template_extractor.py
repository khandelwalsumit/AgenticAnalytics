            ...
            "slides": [
                {
                    ...
                    "content_guidance": "Title: 'EXECUTIVE SUMMARY'. subtitle_lines: 2-4 lines with optional bold_part. quick_wins: 3 {action, detail} objects.",
                    "structured_fields": ["title", "subtitle_lines", "quick_wins"],
                },
                {
                    ...
                    "content_guidance": "Title: assertion with numbers. 3 cards with 2-3 line issue, 1-2 line fix, and separate owner field.",
                    "card_count": 3,
                    "structured_fields": ["title", "cards"],
                    "card_fields": ["name", "calls", "pct", "impact", "priority", "issue", "fix", "owner"],
                },
            ],
        },
        "impact": {
            ...
            "slides": [
                {
                    ...
                    "content_guidance": "Theme list LEFT (~58%), scatter chart RIGHT (~38%). Each theme: name + quadrant, stats. NOT a table.",
                ...
                },
                {
                    ...
                    "layout_name": layouts.get(str(content_idx), {}).get("name", "Content"),
                    "placeholders_used": ["TITLE", "OBJECT"],
                    "content_guidance": "3 easiest solutions sorted by ease. Each: action (13pt blue bold), detail (11pt), impact (10pt muted), ease score, theme name.",
                    "structured_fields": ["title", "items"],
                    "item_fields": ["action", "detail", "impact", "ease", "theme"],
                },
                {
                    ...
                    "layout_name": layouts.get(str(content_idx), {}).get("name", "Content"),
                    "placeholders_used": ["TITLE", "OBJECT"],
                    "content_guidance": "2x2 grid of dimension cards. Each dimension: name + 1-2 actions with title and detail. Colors auto-derived from name.",
                    "structured_fields": ["title", "dimensions"],
                    "dimension_fields": ["name", "actions"],
                },
            ],
        },
