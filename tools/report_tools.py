...
"""
        ...
        return json.dumps({"error": f"generate_markdown_report failed: {exc}"})
...
def export_to_pptx(
    ...
    try:
        ...
        return json.dumps({"error": f"export_to_pptx failed: {exc}"})
...
def export_filtered_csv(output_dir: str = "") -> str:
    ...
    try:
        ...
        return json.dumps({"error": f"export_filtered_csv failed: {exc}"})
