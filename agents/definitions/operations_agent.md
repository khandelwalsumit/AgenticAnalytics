  ...
  "top_drivers": [
    {
      ...
      "type": "primary",
      "operational_breakpoint": "sla_delay",
      "recommended_solution": "Automate crediting pipeline with 2-hour SLA for standard purchases"
    },
    {
      "driver": "Manual approval required for redemptions over threshold",
      "call_count": 9,
      "contribution_pct": 28.1,
      "type": "secondary",
      "operational_breakpoint": "manual_dependency",
      "recommended_solution": "Implement risk-scored auto-approval for 80% of redemptions"
    }
  ],
  "ease_score": 6,
  "impact_score": 8,
...
2. Apply the domain skill frameworks to identify operational failure patterns
...
- **decision**: "analyzed" if you found operational friction, "insufficient_data" if too few rows, "no_friction" if no operational issues
- **confidence**: 0-100
...
- **bucket_analysis**: One BucketAnalysis object with:
  ...
  - preventability_assessment: whether better operational execution would have prevented most calls
