...
2. Apply the domain skill frameworks to identify policy-driven friction patterns
...
- **decision**: "analyzed" if you found policy-driven friction, "insufficient_data" if too few rows, "no_friction" if no policy issues
- **confidence**: 0-100
...
- **bucket_analysis**: One BucketAnalysis object with:
  ...
  - preventability_assessment: whether the friction is inherent to the rule or caused by how the rule is applied
