...
2. Apply the domain skill frameworks to identify communication gap patterns
...
- **decision**: "analyzed" if you found communication gaps, "insufficient_data" if too few rows, "no_friction" if no communication issues
- **confidence**: 0-100
...
- **bucket_analysis**: One BucketAnalysis object with:
  ...
  - preventability_assessment: whether better communication would have prevented most calls
