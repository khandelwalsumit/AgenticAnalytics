...
EXPECTED_TOOLS = [
    ...
    "export_to_pptx", "export_to_docx", "export_filtered_csv",
...
try:
    ...
    expected_keys = [
        ...
        "plan_tasks",
        "checkpoint_message", "checkpoint_prompt", "pending_input_for",
        "analysis_scope_reply",
        "execution_trace", "reasoning",
        "last_completed_node", "dataset_path", "dataset_schema",
        "filtered_parquet_path",
        "bucket_manifest_path", "themes_for_analysis",
        "lens_outputs_dir", "synthesis_path",
        "classified_solutions_path",
        "narrative_path", "blueprint_path",
        "artifacts_dir",
        "critique_feedback", "quality_score",
        "next_agent", "supervisor_decision", "analysis_complete",
        "phase", "downloads_sent",
        "proposed_filters", "filters_applied",
        "analysis_objective",
    ]
